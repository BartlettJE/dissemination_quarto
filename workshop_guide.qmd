...
Once you have a folder your book can live in, set your working directory to this folder, for example from the top menu `Session >> set working directory >> Choose directory` and navigate to this folder. 
