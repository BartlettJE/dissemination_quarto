...
For an example of creating Quarto presentations, you can explore a [papaja demonstration](https://github.com/BartlettJE/papaja_demo){target="_blank"} I presented for the research centre I am affilated with. If there is a feature you like, you can see the [source code on github](https://github.com/BartlettJE/papaja_demo){target="_blank"} to adapt to your needs.
