...
For an example of the PsyTeachR book template, you can explore the [Fundamentals of Quantitative Analysis](https://psyteachr.github.io/quant-fun-v3/){target="_blank"} book. If there is a feature you like, you can see the [source code on github](https://github.com/PsyTeachR/quant-fun-v3){target="_blank"} to adapt to your needs.
...
Alternative/combined solutions:

- https://hugoblox.com/?utm_campaign=poweredby

- https://www.dsquintana.blog/create-an-academic-website-free-easy-2020/

## Creating the book template

Your main source of information for this output is the [Creating a Website](https://quarto.org/docs/websites/){target="_blank"} section of the Quarto guide. 
