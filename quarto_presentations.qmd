...
In future, you could actually start with this part. You can create a new folder, create a repository using this new folder, and then add your new presentation. However, we started by creating the presentation first, so we need to create a repository for an existing folder without a git component.
