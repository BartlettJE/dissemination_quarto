...
For an example of a Quarto website, you can explore [my personal website](https://bartlettje.github.io/){target="_blank"}  or the [UK Conference on Teaching Statistics](https://www.ukcots.org/){target="_blank"} website which I helped to create and maintain. If there is a feature you like, you can see the [source code on github](https://github.com/rssteachingstats/ukcots){target="_blank"} to adapt to your needs.
